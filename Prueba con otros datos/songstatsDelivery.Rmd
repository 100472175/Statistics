...
cor(energy, rithm)
#The best correlation found is: Energy & rithm, with a correlation of 0.8125021
```


With the previous results, we choose the variable $\underline{rithm}$
These are the statistical variables of the $\underline{rithm}$, as well as the Histogram and Box Plot:
